...
export default function PackagesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Featured Package - First one large */}
          ...
          return (
            ...
            >
              <div className="flex flex-col md:flex-row">
                <div className="relative w-full md:w-1/2 h-[250px] sm:h-[300px] md:h-auto md:min-h-[380px] overflow-hidden">
                  <img
                    src={image}
                    alt={pkg.packageName}
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-[#ffc42d] text-gray-900 font-bold px-4 py-1.5 rounded-full text-sm shadow-md">
                    Featured
                  </div>
                </div>
                <div className="p-6 sm:p-8 md:p-10 md:w-1/2 flex flex-col justify-center">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 group-hover:text-[#ffc42d] transition-colors">
                    {pkg.packageName}
                  </h2>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="bg-gray-900 text-white font-semibold px-6 py-2.5 rounded-lg text-sm group-hover:bg-[#ffc42d] group-hover:text-gray-900 transition-colors">
                      View Details
                    </span>
                  </div>
                </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {packages.slice(1).map((pkg, index) => {
            const image = packageImages[pkg.id] || '/package/Vietnam_Standard_Package.webp';
            const days = pkg.summaryItinerary?.length || 0;
            const nights = days > 0 ? days - 1 : 0;
              ...
              >
                ...
                <div className="relative w-full overflow-hidden">
                  <img
                    ...
                    style={{ objectPosition: index === 1 ? 'center 40%' : 'center' }}
                  />
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-3 group-hover:text-[#ffc42d] transition-colors line-clamp-2">
                    {pkg.packageName}
                  </h3>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <span className="text-sm font-semibold text-[#ffc42d] group-hover:underline">
                      Explore →
                    </span>
                  </div>
                </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-gray-900 rounded-2xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link
            href="/contact"
            className="bg-[#ffc42d] hover:bg-[#e6b028] text-gray-900 font-semibold px-8 py-3 rounded-lg transition-colors whitespace-nowrap flex-shrink-0"
          >
            Plan Custom Trip
          </Link>
        </div>
