...
const testimonials = [
  ...
  { author: 'Nihar', text: 'My recent trip to Vietnam with VNDMC was truly an unforgettable experience! The team was professional, friendly, and ensured we enjoyed the beauty of Vietnam, from vibrant cities to stunning landscapes. Highly recommended!' },
  { author: 'Le Hang', text: 'I recently had the pleasure of booking a trip through VNDMC and it was an exceptional experience from start to finish! The tour guides were professional, friendly, and well-informed. The accommodations and transportation were comfortable and convenient.' },
  { author: 'Shah', text: 'The itinerary was well-planned, allowing us to explore the highlights while also having free time to relax. The guide was knowledgeable, friendly, and went above and beyond. I would highly recommend VNDMC for a seamless and enjoyable travel experience!' },
  { author: 'Nguyen Minh Quan', text: 'I recently had the absolute pleasure of experiencing an unforgettable vacation, thanks to the exceptional services provided by VNDMC. Every detail was meticulously planned, ensuring a seamless and enjoyable journey.' },
  { author: 'Duc Chi', text: 'Fantastic experience with VNDMC! The team was professional and attentive, ensuring a smooth and enjoyable trip. Highly recommend for anyone visiting Vietnam.' },
  ...
  { author: 'Sapphire', text: 'My family had a memorable holiday in Phu Quoc - Vietnam. In my next trips, I will definitely continue to choose Vietnam, chose to go with VNDMC.' },
  ...
  { author: 'Gwen', text: 'Good service, reasonable destination, hotel, meals in the program, everything is fine. Thank you VNDMC!' },
  ...
  { author: 'Christopher', text: 'I recently had the pleasure of experiencing a tour with VNDMC, and I must say it was an unforgettable adventure.' },
